...
def boundaryLayerIsothermalPressureInlet(mesh,var,type,dir,val,xi,xf,yi,yf,zi,zf,flowType,E0,P0):
    ...
    if mesh.X[0] <= 0:
        ...
        flowType.disturb[0]['par'] = [1]  # Hold density
    ...
    if hasattr(insideWalls, '__len__'):
