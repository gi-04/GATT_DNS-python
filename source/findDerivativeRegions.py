...
# transformei este script em uma função visto o baixo número de entradas e saídas (gigiaero - 26/08/2024)

def findDerivativeRegions(mesh,boundary):
    ...
    return typeMapX,typeMapY,typeMapZ,derivStartsX,derivStartsY,derivStartsZ,derivEndsX,derivEndsY,derivEndsZ